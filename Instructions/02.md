...
7. Click on **Save Draft** to save the blueprint configurations as draft.
   ...
   >Note: Click **save** and allow approximately **10 seconds** for the Blueprint Definition to be saved
...
7. Now return back to **Blueprints** page, under the **Assigned blueprints** section choose the scope **L2-Governance Sub-Suffix** and select the assignment **Assignment-L2-CAFFoundationzone**.
