...
9. Enter the version as **v1.0** and click on **Publish** to publish the blueprint.

    ![](images/ex1-06-publish.png)
   
10. The Blueprint sample copy is ready to be assigned to the subscription to which it is saved once it is published.
 
11. Select **Assign blueprint** option at the top of the blueprint definition page of **L2-CAFFoundationzone** 
...
12. On the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
...
13. Now the blueprint assignment is created and the artifact deployment begins. This deployment will take around **seven** minutes. 

14. To check on the status of deployment, click on **notifications** icon and click on the **Blueprint assignment succeeded**
    
    ![](images/ex2-notification.png)

15. Observe the resources which are being deployed by the blueprint.
...
17. In the upper left corner of the portal window, to open the Resource Groups menu, click the toggle menu icon and then click on **Resource groups**.
 ...
 18. On the **Resource Groups** blade filter the resource groups by Subscription **L2-Governance Sub-Suffix** and observe that four resource groups named **TTDeploymentIDApplication-rg,TTDeploymentIDVnet-rg, TTDeploymentIDIdentity-rg and TTDeploymentIDSharedSvcs-rg** are created .
 
     >**TTDeploymentIDApplication-rg, TTDeploymentIDVnet-rg and TTDeploymentIDIdentity-rg** are empty resource groups.
     
     ![](images/ex2-rgs.png)
       
 19. Select the resource group **TTDeploymentIDSharedSvcs-rg** and review the deployed resources.
 ...
 20. Now, type **Policy** at the search bar and select **Policy** under services.

     ![](images/ex2-policysearch.png)
     
 21. Click on **Assignments** under Authoring section and select the scope to **L2-Governance Sub-Suffix**
 
 22. Review the policies that are assigned at the subscription **L2-Governance Sub-Suffix** by the blueprint `L2-CAFFoundationzone`
...
2. **Search** for the following policy assignment 
 ...
 3. Similarly search the remaining policy assignments and click on **Add**
...
6. Now return back to **Blueprints** page, under the **Assigned blueprints** section choose the scope **L2-Governance Sub-Suffix** if it is set to different subscription and select the assignment **Assignment-L2-CAFFoundationzone**.

   ![](images/ex2-cafblueprint.png)
  
7. Click on **Update assignment** to update the assignment with latest version of blueprint.
...
11. To check on the status of deployment, click on **notifications** icon and click on the **Blueprint assignment succeeded**
...
15. Click on **Assignments** under Authoring section and select the scope to **L2-Governance Sub-Suffix**
       
16. Review all the policies assigned by the v2.0 blueprint by selecting the scope `L2-Governance Sub-Suffix`
