...
7. Now return back to **Blueprints** page, under the **Assigned blueprints** section choose the scope **L2-Governance Sub-Suffix** and select the assignment **Assignment-L2-CAFFoundation**.
...
13. After the assignment is succeeded, In the upper left corner of the portal window to open the Resource Groups menu, click the toggle menu icon and then click on **Resource groups**.
...
14. Select the resource group **TTDeploymentIDSharedSvcs-rg** and under the **settings** section select **Locks** to see that resource locks are applied for each resource in the resource group.

    ![](images/ex2-locks.png)

15. Now, type **Policy** at the search bar and select **Policy** under services.

    ![](images/ex2-policysearch.png)
       
16. Review all the policies assigned by the blueprint by selecting the scope `L2-Governance Sub-Suffix`
