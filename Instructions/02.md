...
The Microsoft CAF Ready/Govern Methodology for Azure **(CAF) Migration landing zone** blueprint is a set of infrastructure to help you set up for migrating your first workload to azure and manage your cloud estate in alignment with CAF.
...
#### Task 1: Deploy the Microsoft CAF Ready/Govern Methodology for Azure migrate landing zone blueprint sample
...
1. Navigate to the **Blueprints** page and under the **Assigned blueprints** section, select **Assignment-L1-Migrationlandingzone** then click on **Unassign blueprint** and select **OK** to unassign the previously assigned blueprint.
...
5. Click on folder 📂 symbol under Import template and select the file **vnetdmz-deploy.json** located in **C:\LabFiles** which deploys the **virtual network** with DMZ architecture.
...
11. Now on the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
    ...
    **Basics**
     ...
     **Artifact parameters**
      ...
      - **Deploy Azure Migrate:**`Central US`
