...
12. Select the published blueprint definition and click on **Assign blueprint** at the top of the blueprint definition page.
...
14. Once all parameters have been entered, select **Assign** at the bottom of the page. The blueprint assignment is created and artifact deployment begins. Deployment takes aroundfive minutes. To check on the status of deployment, open the **blueprint assignment**.
...
2. Search and add all the following policy definitions to blueprint:
 ...
 >These policy definitions are available along with the blueprint sample
 
   ![](images/ex2-11-search.png) 
  
3. Click on **Save Draft** to save the blueprint configurations as draft.

4. Click on the blueprint definition you just edited and publish the blueprint as **v2.0** and Click on **Publish**

5. Once the edited copy of the blueprint sample has been successfully Published, the assignment can be edited.
 
5. Under **Blueprints->Assigned blueprints** Select the succeeded assignment **Assignment-L2-CAFFoundation** and click on **Update assignment** at the top of the blueprint definition page to update the latest version of blueprint.
