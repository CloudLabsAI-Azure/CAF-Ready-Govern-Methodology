...
5. Next, set the **Definition Location** value to a subscription named **Prefix-MigrationLZ Sub-Suffix** and then click on **Select** and return to the Create blueprint page.
     
   ![](images/definationloc.png) 
