...
>Note: **L2-Governance Sub-DeploymentID** subscription is used to perform this exercise.
...
5. Next, set the **Definition Location** value to a subscription named **L2-Governance Sub-DeploymentID** and then click on **Select** to return back to the Create blueprint page
...
8. Navigate to the **Blueprints** blade then under the **Blueprint definitions** section select the blueprint definition **L2-CAFFoundationzone** .
...
12. Navigate to the **Blueprints** blade then under the **Blueprint definitions** section select the published blueprint definition **L2-CAFFoundationzone**.
...
14. On the **Assign blueprint** page, Provide the parameter values for the blueprint assignment:
     ...
     **Basics**
     ...
     - **Subscriptions**: Choose the subscription `L2-Governance Sub-DeploymentID` where your copy of the blueprint sample is saved to.
...
16. To check on the status of deployment, open the blueprint assignment **Assignment-L2-CAFFoundation** from the **Blueprints** pane and **Assigned blueprints** section.

    ![](images/ex2-09-assignmentstatus.png) 
    
17. Once the assignment is **succeeded** review the resources deployed by the blueprint.
...
18. In the upper left corner of the portal window, to open the Resource Groups menu, click the toggle menu icon and then click on **Resource groups**.
 ...
 19. Three resource groups named **Application-rg, Identity-rg and SharedSvcs-rg** are created under the subscription **L2-Governance Sub-DeploymentID** where in **Application-rg and Identity-rg** are empty resource groups.
       
 20. Select the resource group **SharedSvcs-rg** and check the deployed resources.
...
In this task you will explore the resources deployed and policies included in the blueprint **CAFFoundationzone**.

1. Go to **Blueprints|Blueprint definitions** and select **L2-CAFFoundationzone** that is the blueprint definition created in task 1 and Click on **Edit blueprint**.
...
14. Review all the policies applied by the blueprint by selecting the scope `L2-Governance Sub-DeploymentID`

    ![](images/ex2-policies.png)
    
    >CAF Foundation zoneblueprint is deployed in `L2-Governance Sub-DeploymentID` so we are setting the scope for this subscription.
