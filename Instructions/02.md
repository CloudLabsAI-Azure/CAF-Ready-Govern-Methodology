...
15. Once the assignment is **succeeded** review the resources deployed by the blueprint.
...
16. In the upper left corner of the portal window, to open the Resource Groups menu, click the toggle menu icon and then click on **Resource groups**.
 ...
 17. Three resource groups named **Application-rg, Identity-rg and SharedSvcs-rg** are created under the subscription **L2-Governance Sub-DeploymentID** where in **Application-rg and Identity-rg** are empty resource groups.
       
 18. Select the resource group **SharedSvcs-rg** and check the deployed resources.
