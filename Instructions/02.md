...
11. After the assignment is succeeded, type **Policy** at the search bar and select **Policy** under services.

    ![](images/ex2-policysearch.png)
    
12. Review all the policies applied by the blueprint by selecting the scope 

    ![](images/ex2-policy.png)
