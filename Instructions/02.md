...
8. Navigate to the **Blueprints** blade then under the **Blueprint definitions** section select the scope **L2-Governance Sub-Suffix** if it is set to different subscription and click on the blueprint definition **L2-CAFFoundationzone** .
