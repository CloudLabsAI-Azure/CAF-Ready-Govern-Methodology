...
18. In the upper left corner of the portal window, to open the Resource Groups menu, click the toggle menu icon and then click on **Resource groups**.
 ...
 19. Three resource groups named **Application-rg, Identity-rg and SharedSvcs-rg** are created under the subscription **L2-Governance Sub-Suffix** where in **Application-rg and Identity-rg** are empty resource groups.
