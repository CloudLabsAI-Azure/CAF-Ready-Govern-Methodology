...
3. Now on the **Create blueprint** page, under the **Choose a blueprint sample** header, type **CAF** at the search bar and select the predefined blueprint sample **CAF **CAF Foundation Zone**. You will be redirected to **Create blueprint** page.

   ![](images/EX2-CAF Foundation Zone.png) 
...
8. Navigate to the **Blueprints** blade then under the **Blueprint definitions** section,select the blueprint definition **L2CAFFoundationzone** 
...
12. Navigate to the **Blueprints** blade then under the **Blueprint definitions** section,select the published blueprint definition **L2CAFFoundationzone**.
...
14. On the **Assign blueprint** page, Provide the parameter values for the blueprint assignment:
     ...
     **Basics**
     ...
     - **Subscriptions**: **L2-Governance Sub-DeploymentID**
     ...
     **Blueprint parameters:** 
     ...
     - **Organization**: Enter your organization name as **TWTL2-DeploymentID** 
