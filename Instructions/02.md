...
4. Now navigate to **Blueprints** page and under the **Blueprint definitions** section click on the edited blueprint definition **L2-CAFFoundationzone**.

5. Select the **Publish blueprint** option and provide the version as **v2.0** and click on **Publish**.
   
   ![](images/ex1-16-publishv2.png).
 
6. Under **Blueprints->Assigned blueprints**, Select the assignment **Assignment-L2-CAFFoundation** and click on **Update assignment** to update the assignment with latest version of blueprint.

    ![](images/ex2-12-updateassignment.png) 

7. On the **Assign blueprint** provide the parameter values for the to update the blueprint assignment:
...
8. Once all parameters have been entered, Click on **Assign** at the bottom of the page.

9. The blueprint assignment is created and artifact deployment begins , the deployment takes around **five** minutes. 

10. To check on the status of deployment, open the blueprint assignment.

11. After the assignment is succeeded, In the upper left corner of the portal window to open the Resource Groups menu, click the toggle menu icon and then click on **Resource groups**.
    
    ![](images/ex1-resourcegroups.png)
    
    This blade displays all of the resource groups that you have access to the Azure subscriptions.
  
12. Select the resource group **SharedSvcs-rg** and under the **settings** section select **Locks** to see that resource locks are applied for each resource in the resource group.

13. Now, type **Policy** at the search bar and select **Policy** under services.

    ![](images/ex2-policysearch.png)
       
14. Review all the policies applied by the blueprint by selecting the scope `L2-Governance Sub-Suffix`
