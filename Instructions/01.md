...
10. Enter the version as **v1.0** and click on **Publish** to publish the blueprint.
 ...
 14. On the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
     ...
     **Basics**
     - **Subscriptions**: The subscription `L1-MigrationLZ Sub-Suffix` chould be pre-selected and grayed out. This value reflects the Subscription where your Blueprint copy is saved.
