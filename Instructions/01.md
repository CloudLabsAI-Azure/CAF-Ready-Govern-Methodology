...
- In the **gateway subnet**, traffic sent to the core-tier subnet (10.0.4.0/24) is routed through the Azure Firewall instance.
- NEED to review as there is no web tier subnet configured at this point. In the **web tier subnet**, Since there is no route for address space of the VNet itself to point to Azure firewall, web tier instances can communicate directly to each other, not via Azure Firewall.
...
1. Navigate to the **Blueprints** page and under the **Assigned blueprints** section, select **Assignment-L1-Migrationlandingzone** then click on **Unassign blueprint** to unassign the previously assigned blueprint.
   ...
   >Confirm that you want to remove the blueprint assignment by clicking on **OK**
