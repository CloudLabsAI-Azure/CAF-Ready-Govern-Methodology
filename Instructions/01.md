...
8. Navigate to the **Blueprints** blade, then under the **Blueprint definitions** section select the blueprint definition **L1-MigrationLandingzone**.
   ...
   >Verify that the definition location is set to the subscription **L1-MigrationLZ Sub-Suffix**. If it is not, edit the Blueprint Definition and set it to L1-MigrationLZ Sub-Suffix subscription before continuing.
...
10. Enter the version as **v1.0** and click on **Publish** to publish the blueprint.
 ...
 12. Now return to the **Blueprints** blade and then under the **Blueprint definitions** section, select the published blueprint definition **L1-MigrationLandingzone**.
 
 13. Select the **Assign blueprint** option at the top of the blueprint definition page. 
