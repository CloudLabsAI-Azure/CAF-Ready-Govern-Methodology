...
- [Task 1: Deploy Azure landing zone accelerator with hub and spoke architecture](#task-1-deploy-Azure-landing-zone-accelerator-with-hub-and-spoke-architecture)
