...
1. Once the template deployment is completed you will see **Your deployment is complete** message on deployment page. It will take upto 90 Minutes to finish.
   ...
   > **Fix deployment**: Redeploy the template by following above steps in the [Task-1 from Step-1](https://github.com/CloudLabsAI-Azure/AVW-Cloud-Adoption-Framework/blob/stage/Instructions/01.md) which fix the issues most of the time. 
