...
- [Task 1: Deploy Landing zone accelerator](#task-1-deploy-landing-zone-accelerator)
- [Task 2: Validation post deployment (GitHub)](#task-2-validation-post-deployment-github)
- [Post deployment activities](#post-deployment-activities)

## Task 1: Deploy Landing zone accelerator

In this task, you are deploying the landing zone accelerator with hub and spoke architecture. To start with deploying, we will use the AdventureWorks reference implementation ARM template. 
