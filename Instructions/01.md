...
6. Select **Unassign blueprint** to unassign the previously assigned blueprint of task 1.
   
   ![](images/ ex1-17-unassign.png)
  
5. Now click on **Assign blueprint** and wait for provisioning state to be **Succeeded**.

6. You have successfully deployed the blueprint which has VNET that matches the DMZ architecture.
