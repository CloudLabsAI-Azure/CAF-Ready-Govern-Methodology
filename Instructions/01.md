...
5. On **Platform DevOps and automation** section, make sure for `Deploy integrated CICD pipeline` **Yes** option is selected, then
   - GitHub Organization or username: enter your GitHub account username (1)
   - New GitHub repository name: `eslz` (2)
   - GitHub personal access token: Genrate GitHub personal access token 
