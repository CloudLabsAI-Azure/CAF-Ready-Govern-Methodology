...
14. On **Landing zone configuration** section, select **Yes (recommended)** (1) for Connect corp landing zones to connectivity hub (optional)?, then from **Subscriptions** select **L3 - ES Landing Zones Sub - Suffix** and provide `10.50.0.0/24` (2) for Vitual Network Address space. Now, click on **Next : Review + create >** (3) to review the input parameters you have given and selected.
...
15. Review the input parameteres which you have selected for each section/platform before clicking on the **Create** buttom. Once reviewed, click on the **Create** button to begin the deployment.
