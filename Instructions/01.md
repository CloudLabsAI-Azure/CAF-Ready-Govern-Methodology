...
>Note: **L1-MigrationLZ Sub-Suffix** subscription is used to perform this exercise. Suffix is the 4 digit XXXX value of the username , for example if the username is odl_user_238206@azurehol**1505**.onmicrosoft.com, 1505 is the Suffix value.
