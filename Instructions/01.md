...
8. Click on **Publish blueprint** from the **L1-MigrationLandingzone** page.
...
9. Enter the version as **v1.0** and click on **Publish** to publish the blueprint.
 ...
 11. Select the **Assign blueprint** option at the top of the blueprint definition page. 
 ...
 12. On the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
     ...
     **Blueprint parameters:** 
     ...
     - **Organization:** Enter your organization name as `TWTDeploymentID`
       >Get the DeploymentID from the Lab Environment tab. For example, if your DeploymentID is 238206 the name will be `TWT238206`
...
13. Now the blueprint assignment is created and the artifact deployment begins. This deployment will take around **five** minutes. 

14. To check on the status of the deployment, click on the **notifications** icon and click on the **Blueprint assignment succeeded**
...
18. On the **Resource Groups** blade filter the resource groups by Subscription **L1-MigrationLZ Sub-Suffix** and verify that four resource groups named -  **TWTDeploymentIDMigrate-rg, TWTDeploymentID-SharedSvcs-rg, and TWTDeploymentID-VNet-rg**, **NetworkWatcherRG** are created by the blueprint.

    ![](images/ex1-resourcegroupsnames1.png)
    
19. Review the deployed resources in each resource group.

20. Under the **Resource groups** blade Click on **TWTDeploymentID-Migrate-rg** and then Click on **Show Hidden types** to see the resources created in this resource group.

    ![](images/ex1-15-migratergrp1.png)
...
21. Now return to the **Resource groups** blade and click on **TWTDeploymentID-SharedSvcs-rg** and review the deployed resources.
...
22. Again return to the **Resource groups** blade and click on **TWTDeploymentID-VNet-rg** to check for the resources created in this resource group.
 ...
 23. Click on **Virtual network** in the resource group and then select **Subnets** under the Settings section and look at the subnets deployed.
 ...
 24. Again return to the **Resource groups** blade and click on **NetworkWatcherRG** and see that Network watcher is deployed.
...
7. Click on **Publish blueprint**.

   ![](images/ex1-06-publishbp.png) 

8. Select the **Publish blueprint** option and provide the version as **v2.0** then click on **Publish** to save the changes.
  
   ![](images/ex1-16-publishv2.png) 

9. Then click on the **Assign blueprint** option to assign the updated blueprint.

10. Now on the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
    ...
    **Basics**
     ...
     **Blueprint parameters:** 
     ...
     - **Organization:** Enter your organization name as `DMZDeploymentID`
      >Get the DeploymentID from the Lab Environment tab. For example, if your DeploymentID is 238206 the name will be `DMZ238206`
...
11. Now the blueprint assignment is created and the artifact deployment begins. This deployment will take around **five** minutes. 

12. To check on the status of the deployment, click on the **notifications** icon and click on the **Blueprint assignment succeeded**
    
    ![](images/ex1-notification.png)
     
     >You can also check the deployment status by opening the blueprint assignment **Assignment-L1-Migrationlandingzone** from the **Blueprints** page and **Assigned blueprints** section, ensure you select the right scope **L1-MigrationLZ Sub-Suffix**
 
13. After the assignment is **Succeeded** review the deployed Virtual Network with DMZ architecture.
...
15. On the **Resource Groups** blade filter the subscription **L1-MigrationLZ Sub-Suffix** and select the resource group **DMZDeploymentIDVNet-rg** and review the resources deployed along with the virtual network
...
16. Select the virtual network and under the **settings** select **Subnets** option to see the created subnets with Virtual network.
