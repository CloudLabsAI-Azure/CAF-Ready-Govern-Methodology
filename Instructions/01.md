...
15. To check on the status of deployment, open the blueprint assignment **Assignment-L1-Migrationlandingzone** from the **Blueprints** pane and**Assigned blueprints** section.
...
>Note: To find more information about CAF migration landing zone follow this link: https://docs.microsoft.com/en-us/azure/architecture/reference-architectures/dmz/secure-vnet-dmz
