...
1. From the Azure portal , type **Blueprint** at the search bar and select the **Blueprint service** 
   
   ![](images/ex1-00-searchblueprint.png) 
   
2. From the **Blueprints| Getting started** page, under the **Create a blueprint** header click on **Create** to start configuring the blueprint. 
...
14. Now the blueprint assignment is created and artifact deployment begins. This deployment will take around five minutes. 

15. To check on the status of deployment, open the blueprint assignment.
