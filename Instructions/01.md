...
1. Varify the 4 secrets with following names below has been already created under **Action secrets**. 
...
1. Now, under **Actions**, varify a Workflow is either in progress or has completed and automatically merged into the main branch.
