...
1. Edit blueprint -> Next Artifacts-> Remove the existing code for **Deploy Vnet Landing zone** and replace it with https://raw.githubusercontent.com/srushti-714/Cloud-Adoption-Framework-In-A-Day/main/Instructions/Templates/DMZ-VNET.json

2. Save Draft 

3. Publish the blueprint as V2

4. Unassign the blueprint you created in previous steps.

4. Click on Assign blueprint and wait for provisioning state to be Succeeded.

5. Now you have successfully deployed the blueprint which has VNET that matches the DMZ architecture.
