...
7. Click on **Save Draft** to save the blueprint configurations.

8. After the blueprint definition is saved , next step is to publish the blueprint.
