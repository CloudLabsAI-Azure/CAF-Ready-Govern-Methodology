...
10. Enter the version as **v1.0** and click on **Publish** to publish the blueprint.
 ...
 12. Now navigate to the **Blueprints** blade then under the **Blueprint definitions** section and select the published blueprint definition **L1-MigrationLandingzone**.
