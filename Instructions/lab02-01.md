...
11. Now on **Pick an account** window select **+ Use another account** and eneter your Azure Credentials mentioned below:
...
15. Once the scriptis executed, you terminal should look like following.
