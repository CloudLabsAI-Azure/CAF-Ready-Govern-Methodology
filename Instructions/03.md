...
9. Navigate to Azure **Policy** and select **compliance** from the left hand menu. Under **scope**, select the management group **WT-management** and review the compliance state of the policies.
