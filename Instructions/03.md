...
10. Click on the **ES** Management Group. 
...
12. Next, in the **ES** Management Group blade, click on **Policy** under Governance section.

    ![](images/Ex3-dep-12p.png) 

13. In the **Policy | Definitions** blade, select the scope **ES** and under **Type** select **Custom**, you will see a list of Initiative and policy definitions as shown below which are assigned at the management group level.
...
15. On the **Resource Groups** blade, Select the subscription **L3- ES Management Sub - Suffix** and select the resource group **ES-mgmt**.
     
    ![](images/Ex3-dep-15p.png)

16. On the **ES-mgmt** page, review the resources deployed by the ARM template
