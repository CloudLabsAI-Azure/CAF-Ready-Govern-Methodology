...
4. Now, click **Create pull request (1)**.  A new Pull Request is being created which will trigger the Push workflow. Go to **Actions (2)** to monitor the process.
...
10. Now, go to teh Azure portal, where you have logged in already, in search box type `Management groups` (1) and then click on **Management groups** under services. 
