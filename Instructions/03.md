...
10. Click on **Access control (IAM (1)** on the subscription ***L2 - Identity Sub - Suffix**. Next, click on **Role assignments (2)** and verify if **Contributor (3)** role is assigned on the subscription for <inject key="AzureAdUserEmail" />
