...
7. To check the deployement status click on **Notification** icon and Click on **Deployment in Progress**.
...
#### Task 2: Deploy Resources into Enterprise scale landing zone (ESLZ).
