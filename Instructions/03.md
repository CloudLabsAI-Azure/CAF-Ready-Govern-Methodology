...
4. **Create a key vault** by providing the following details:
   ...
   - Provide the keyvault name : **kvDeploymentID**
     >Get the **DeploymentID** value from the Lab Environment tab , Suppose 257725 is the DeploymentID , the keyvaultname should be like kv257725.
...
2. Under **Policy** blade, select **Definitions** under the Authoring section and select the **WT-online** management group as scope.
    ...
    - Definition type: Choose **Policy** and click on policy **KeyVault SoftDelete should be enabled**
