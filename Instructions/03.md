...
>You will see **DeploymentID** value on the Environment detauks tab, please use it wherever you see DeploymentID in lab steps. This is a unique number associated with each lab deployment.
...
1. Click on the **Deploy to Azure** button, If prompeted **Signin** with the lab credentails. Ensure to deploy the ARM template in the lab account provided. 
