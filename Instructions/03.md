...
>If it is opening a new window outside the virtual machine, select the **Deploy to Azure** button right click & copy the URL then open the copied URL in browser of virtual machine to deploy the ARM Template. This link will deep link into the Azure Portal, passing in the ARM Template for deploying the resources.
