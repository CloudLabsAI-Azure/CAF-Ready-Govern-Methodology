...
>**Note:** You will use the subscriptions L3 - ES Landing Zone Sub -Suffix and L3- ES Management Sub - Suffix for peforming this exercise.
...
6. Post a successful deployment of the KeyVault, you should start to see (approx. 6-10 minutes) another deployment of the resource appearing in the resource group.
   ![](images/ex3t2-4.png)
