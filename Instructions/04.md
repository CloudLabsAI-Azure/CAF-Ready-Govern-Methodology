...
8. **Refresh** the page once Inventory is enabled.

9. After adding the Virtual machine to Inventory, it should show under the **Machines** tab.
...
10. Now from the **Automation account| Inventory** blade, click on **Edit Settings**. This will redirect you to **Workspace Configuration** page

   ![](images/ex4-6-editsettings.png)

11. On the **Workspace Configuration** page under the **Windows Registry**, review the **Registry keys** available.
...
5. On the **Enable Update Management** page ensure the subscription **Sub 05-Suffix** and resource group **CAF** are already selected then select the virtual machine **labvm-DeploymentID** and click on **Enable** enable Update Management.
...
3. On the **New update deployment** page. Provide the following details and click on **Create**.
    ...
    >Get the DeploymentID value from the Environment details tab , Suppose 257725 is the DeploymentID the name should be like update-257725.
    
    - Operating system: **Windows**
    - **Machines to update** under the Items to update section: Under **Type**, select **Machines** from the dropdown. Under **Machine name** select **labvm-DeploymentID**
