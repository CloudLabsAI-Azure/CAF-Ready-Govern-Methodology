...
4. In **advanced settings**, select the subscription **Sub 05-Suffix** and region **CentralUS** 
   ...
   Then select **CAF** resource group and choose the **existing storage account** **storage<inject key="DeploymentID" enableCopy="false"/>** create a file share fs, and click on **Create Storage**.
...
3. On the **New update deployment** page. Provide the following details and click on **Create**.
    ...
    - DeploymentID: <inject key="DeploymentID" enableCopy="false"/>
