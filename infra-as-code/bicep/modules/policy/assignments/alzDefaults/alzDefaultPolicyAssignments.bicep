...
param parLogAnalyticsWorkSpaceAndAutomationAccountLocation string = 'centralus'
...
param parLogAnalyticsWorkspaceLogRetentionInDays string = '30'

@description('Automation account name. - DEFAULT VALUE: alz-automation-account')
param parAutomationAccountName string = 'eslz-automation-account'
